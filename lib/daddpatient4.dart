...
import 'package:medicproject/daddpatient5.dart';
import 'package:medicproject/dhome.dart';

class Register4 extends StatefulWidget {
  final String username;

  Register4({required this.username});
                        ...
                        ElevatedButton(
                          onPressed: () {
                            ...
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) =>
                                    Register5(username: widget.username),
                              ),
                            );
                          },
                          child: Text('Yes'),
