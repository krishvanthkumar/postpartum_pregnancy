...
import 'package:medicproject/daddpatient4.dart';
import 'package:medicproject/dhome.dart';

class Register3 extends StatefulWidget {
  final String username;

  Register3({required this.username});
                        ...
                        ElevatedButton(
                          onPressed: () {
                            ...
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) =>
                                    Register4(username: widget.username),
                              ),
                            );
                          },
                          child: Text('Yes'),
