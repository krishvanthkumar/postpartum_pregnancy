...
import 'package:medicproject/ghome.dart';
import 'package:sizer/sizer.dart';

class GMoodAnalysis extends StatefulWidget {
  final String username;

  GMoodAnalysis({required this.username});

  @override
  _GMoodAnalysisState createState() => _GMoodAnalysisState();
}

class _GMoodAnalysisState extends State<GMoodAnalysis> {
  late String mood = '';
  late String mDate;

  final String url = gmooduri;
                    ...
                    ElevatedButton(
                      onPressed: () {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => GPatientDetail()),
                        );
                      },
